 ...
 */
public class RockHountRunner
{
    public static void main(String[] args)
    {
        ActorWorld world = new ActorWorld();
        world.add(new Location(7, 8), new Rock());
        world.add(new Location(3, 3), new Rock(Color.BLUE));
        ...
        world.add(new Location(4, 4), new RockHount());
        world.add(new Location(5, 8), new RockHount());
        world.show();
    }
}